import { integer, pgTable, pgEnum, text, varchar, boolean, timestamp, index } from "drizzle-orm/pg-core";
import { relations } from "drizzle-orm";
import { createdAt, id, updatedAt } from "../schemaHelpers";
import { OrganizationTable } from "./organization";
import { JobListingApplicationTable } from "./jobListingApplication"; // <- import your applications table
...
export const JobListingTable = pgTable(
  ...
  (table) => [index("state_idx").on(table.stateAbbreviation)]
);

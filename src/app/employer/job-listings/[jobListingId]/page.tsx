...
import { getNextJobListingStatus } from "@/features/jobListings/lib/util"
    ...
    <div className="space-y-6 max-w-6xl mx-auto p-4 @container">
      <div className="flex items-center justify-between gap-4 @max-4xl:flex-col @max-4xl:items-start">
        ...
        <div className="flex items-center gap-2 empty:-mt-4">
          <AsyncIf
            condition={() => hasOrgUserPermission("applicant_change:job_listings_update")}
          >
          ...
          <AsyncIf
            condition={() => hasOrgUserPermission("applicant_change:job_listings_delete")}
          >
            <ActionButton
              variant="destructive"
...
function StatusUpdateButton({
  ...
  return (
    <AsyncIf
      condition={() => hasOrgUserPermission("applicant_change:job_listings_change_status")}
    >
